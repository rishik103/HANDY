...
def generate_launch_description():
    ...
    rviz_base = os.path.join(
        get_package_share_directory("arm_config"), "launch"
    )
    ...
    robot_description = ParameterValue(
        Command(
            [
                "xacro ",
                os.path.join(get_package_share_directory("arm_config"),"config","handy.urdf.xacro")
            ]
        ),
        value_type=str,
    )
    # Keep passing robot_description as a parameter to eliminate races (warning is harmless)
